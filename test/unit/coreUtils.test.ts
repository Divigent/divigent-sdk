...
describe('core utils', () => {
  // Exercises: parses and formats USDC with 6 decimals.
  ...
  // Exercises: rejects USDC precision beyond 6 decimals before money math runs.
  ...
  // Exercises: rejects malformed USDC strings instead of guessing user intent.
  ...
  // Exercises: parses very large valid USDC strings exactly.
  ...
  // Exercises: applies basis points with floor rounding.
  it('applies basis points with floor rounding', () => {
    expect(applyBps(101n, 100n)).toBe(1n);
    expect(applyBps(10_000n, 25)).toBe(25n);
  });
  // Exercises: applies basis-point boundaries consistently for number and bigint inputs.
  ...
  // Exercises: derives slippage guards and rejects invalid bps.
  ...
  // Exercises: never rounds slippage protection upward on tiny amounts.
  ...
  // Exercises: calculates fee and rejects invalid fee bps.
  ...
  // Exercises: rescales decimals with floor and ceil rounding.
  ...
  // Exercises: validates branded address and transaction hash inputs.
